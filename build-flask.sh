...
wget "https://raw.githubusercontent.com/cmndcntrl/auto/main/fresh-ubun.sh" | bash -

echo "What is the name of your app?"
read name

curl "https://raw.githubusercontent.com/cmndcntrl/auto/main/start-apache2.sh" | bash
